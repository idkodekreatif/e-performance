...
class KaRisbangController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $karisbang->q1 = $request->get('q1');
            $karisbang->q2 = $request->get('q2');
            $karisbang->q3 = $request->get('q3');
            $karisbang->q4 = $request->get('q4');
            $karisbang->q5 = $request->get('q5');
            $karisbang->q6 = $request->get('q6');
    ...
    public function raport($user_id)
    {
        $DataUser = DB::table('users')
            ...
            ->where('ikbis_ka_lem_risbang.user_id', $user_id)
            ->first();
    ...
    {
        $data = KaRisbang::where('user_id', '=', $userId)->first();
