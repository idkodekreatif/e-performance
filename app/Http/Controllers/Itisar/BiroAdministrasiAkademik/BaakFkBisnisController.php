...
class BaakFkBisnisController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $baakbisnis->q1 = $request->get('q1');
            $baakbisnis->q2 = $request->get('q2');
            $baakbisnis->q3 = $request->get('q3');
            $baakbisnis->q4 = $request->get('q4');
            $baakbisnis->q5 = $request->get('q5');
            $baakbisnis->q6 = $request->get('q6');
    ...
    public function raport($user_id)
    {
        $DataUser = DB::table('users')
            ...
            ->where('ikbis_baak_bisnis.user_id', $user_id)
            ->first();
    ...
    {
        $data = BaakFkBisnis::where('user_id', '=', $userId)->first();
