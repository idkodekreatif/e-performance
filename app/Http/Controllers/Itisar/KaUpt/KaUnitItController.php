...
class KaUnitItController extends Controller
{
    ...
    public function update(Request $request, $PointId)
    {
        ...
        try {
            ...
            if ($request->hasFile('file_kinerja_kompetensi_1')) {
                if ($RecordData->file_kinerja_kompetensi_1 && file_exists(storage_path('app/public/uploads/KaUpt/KaUnitIt/' . $RecordData->file_kinerja_kompetensi_1))) {
                    \Storage::delete('public/uploads/KaUpt/KaUnitIt/' . $RecordData->file_kinerja_kompetensi_1);
                }
                $file_kinerja_kompetensi_1 = $request->file('file_kinerja_kompetensi_1')->store('uploads/KaUpt/KaUnitIt', 'public');
            } else {
            ...
            if ($request->hasFile('file_kinerja_kompetensi_4')) {
                if ($RecordData->file_kinerja_kompetensi_4 && file_exists(storage_path('app/public/uploads/KaUpt/KaUnitIt/' . $RecordData->file_kinerja_kompetensi_4))) {
                    \Storage::delete('public/uploads/KaUpt/KaUnitIt/' . $RecordData->file_kinerja_kompetensi_4);
                }
                $file_kinerja_kompetensi_4 = $request->file('file_kinerja_kompetensi_4')->store('uploads/KaUpt/KaUnitIt', 'public');
            } else {
            ...
            if ($request->hasFile('file_kinerja_kompetensi_8')) {
                if ($RecordData->file_kinerja_kompetensi_8 && file_exists(storage_path('app/public/uploads/KaUpt/KaUnitIt/' . $RecordData->file_kinerja_kompetensi_8))) {
                    \Storage::delete('public/uploads/KaUpt/KaUnitIt/' . $RecordData->file_kinerja_kompetensi_8);
                }
                $file_kinerja_kompetensi_8 = $request->file('file_kinerja_kompetensi_8')->store('uploads/KaUpt/KaUnitIt', 'public');
            } else {
    ...
    public function searchRaport()
    {
        ...
        return view('itisar.ka-upt.ka-unit-it.searchRaport', compact('users'));
    }
    ...
    public function resultRaport(Request $request)
    {
        $DataUser = DB::table('users')
            ...
            ->where('ikbis_ka_unit_it.user_id', '=', $request->id)
            ->first();
