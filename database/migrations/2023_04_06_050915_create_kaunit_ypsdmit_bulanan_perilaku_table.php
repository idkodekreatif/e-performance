...
class CreateKaunitYpsdmitBulananPerilakuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kaunit_ypsdmit_bulanan_perilaku', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('kaunit_ypsdmit_bulanan_perilaku');
    }
}
