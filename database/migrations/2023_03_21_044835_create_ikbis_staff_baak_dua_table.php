...
class CreateIkbisStaffBaakDuaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_staff_baak_dua', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('kinerja_kompetensi_48', ['1', '2', '3', '4', '5'])->nullable();
            $table->string('file_kinerja_kompetensi_48')->nullable();
            $table->enum('kinerja_kompetensi_49', ['1', '2', '3', '4', '5'])->nullable();
            $table->string('file_kinerja_kompetensi_49')->nullable();
    ...
    {
        Schema::dropIfExists('ikbis_staff_baak_dua');
    }
}
