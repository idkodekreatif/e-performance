...
class CreateKasubBiroKepegawaianTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kasub_biro_kepegawaian', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('kasub_biro_kepegawaian');
    }
}
