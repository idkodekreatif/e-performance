...
class CreateIktisarWarek2BulananPerilakuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iktisar_warek2_bulanan_perilaku', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('iktisar_warek2_bulanan_perilaku');
    }
}
