...
class CreateIkbisKaPerpustakaanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_ka_perpustakaan', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_ka_perpustakaan');
    }
}
