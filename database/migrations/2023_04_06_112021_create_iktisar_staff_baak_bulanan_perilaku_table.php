...
class CreateIktisarStaffBaakBulananPerilakuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iktisar_staff_baak_bulanan_perilaku', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('iktisar_staff_baak_bulanan_perilaku');
    }
}
