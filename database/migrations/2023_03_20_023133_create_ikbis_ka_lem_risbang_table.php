...
class CreateIkbisKaLemRisbangTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_ka_lem_risbang', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_ka_lem_risbang');
    }
}
