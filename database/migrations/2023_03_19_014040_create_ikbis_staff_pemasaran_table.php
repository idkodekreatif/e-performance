...
class CreateIkbisStaffPemasaranTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_staff_pemasaran', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_staff_pemasaran');
    }
}
