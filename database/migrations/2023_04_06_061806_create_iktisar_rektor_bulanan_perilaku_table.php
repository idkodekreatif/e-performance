...
class CreateIktisarRektorBulananPerilakuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iktisar_rektor_bulanan_perilaku', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('iktisar_rektor_bulanan_perilaku');
    }
}
