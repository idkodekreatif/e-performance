...
class CreateStaffUmumDanKepegawaianTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('staff_umum_dan_kepegawaian', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('staff_umum_dan_kepegawaian');
    }
}
