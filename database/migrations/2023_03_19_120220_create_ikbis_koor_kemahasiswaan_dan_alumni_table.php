...
class CreateIkbisKoorKemahasiswaanDanAlumniTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_koor_kemahasiswaan_dan_alumni', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_koor_kemahasiswaan_dan_alumni');
    }
}
