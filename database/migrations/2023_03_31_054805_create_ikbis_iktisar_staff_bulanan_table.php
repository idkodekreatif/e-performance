...
class CreateIkbisIktisarStaffBulananTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_iktisar_staff_bulanan', function (Blueprint $table) {
            $table->id();
            ...
            $table->float('total_poin_kali_bobot', 8, 2);
            $table->float('total_nilai_presentase', 8, 2);
    ...
    {
        Schema::dropIfExists('ikbis_iktisar_staff_bulanan');
    }
}
