...
class CreateIkbisKasubBiroKepegawaianTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_kasub_biro_kepegawaian', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_kasub_biro_kepegawaian');
    }
}
