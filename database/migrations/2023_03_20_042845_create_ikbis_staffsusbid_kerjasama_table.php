...
class CreateIkbisStaffsusbidKerjasamaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_staffsusbid_kerjasama', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_staffsusbid_kerjasama');
    }
}
