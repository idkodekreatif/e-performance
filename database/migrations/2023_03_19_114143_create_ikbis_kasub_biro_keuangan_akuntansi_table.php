...
class CreateIkbisKasubBiroKeuanganAkuntansiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_kasub_biro_keuangan_akuntansi', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_kasub_biro_keuangan_akuntansi');
    }
}
