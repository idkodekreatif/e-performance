...
class CreateIkbisKemahasiswaanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_kemahasiswaan', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_kemahasiswaan');
    }
}
