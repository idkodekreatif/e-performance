...
class CreateIktisarLpmBulananPerilakuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iktisar_lpm_bulanan_perilaku', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('iktisar_lpm_bulanan_perilaku');
    }
}
