...
class CreateIkbisStaffUmumDanKepegawaianTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikbis_staff_umum_dan_kepegawaian', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ikbis_staff_umum_dan_kepegawaian');
    }
}
