...
class CreateIktisarStaffHrdBulananPerilakuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('iktisar_staff_hrd_bulanan_perilaku', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('iktisar_staff_hrd_bulanan_perilaku');
    }
}
