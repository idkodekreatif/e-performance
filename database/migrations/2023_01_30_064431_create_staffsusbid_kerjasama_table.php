...
class CreateStaffsusbidKerjasamaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('staffsusbid_kerjasama', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('staffsusbid_kerjasama');
    }
}
