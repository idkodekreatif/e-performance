<x-app-layout title="Edit Penilaian Rektor | Warek II">
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.WarekDua', ['pointId' => $data->user_id]) }}" id="my-form" method="POST"
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>B</td>
                                        <td>Upaya peningkatan mutu secara berkelanjutan pada bidang administrasi umum,
                                            keuangan dan kepegawaian institut..</td>
                                        <td><input type="radio"
