<x-app-layout title="Form Penilaian Rektor | Warek I">
    @push('style')
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                {{-- <a href="{{ route('warekSatu.raport', Auth::user()->id) }}" class="btn btn-primary btn-sm mb-2 float-end">Raport</a> --}}
                <a href="{{ route('edit.warekSatu') }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.warekSatu') }}" id="my-form" method="POST" enctype="multipart/form-data">
            @csrf
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Mengkoordinasikan dan Melaksanakan fungsi perencanaan, pelaksanaan dan
                                            pengawasan pada bidang administrasi akademik dan
                                            kemahasiswaan, bidang data dan informasi dan pada bidang tridarma perguruan
                                            tinggi.</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Mengkoordinasikan dan Menentukan program kerja bidang administrasi akademik
                                            dan kemahasiswaan, data dan informasi serta
                                    ...
                                    <tr>
                                        ...
                                        <td>memimpin pelaksanaan administrasi
                                            akademik dan kemahasiswaan, data dan informasi institut.</td>
                                    ...
                                    <tr>
                                        <td>B</td>
                                        <td>memimpin pelaksanaan tridarma
                                            perguruan tinggi.</td>
                                    ...
                                    <tr>
                                        <td>C</td>
                                        <td>upaya peningkatan mutu pada bidang
                                            administrasi akademik dan kemahasiswaan , data dan informasi serta tridharma
                                            perguruan tinggi.</td>
