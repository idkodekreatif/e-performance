    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.warekSatu', Auth::user()->id) }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.warekSatu') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>4.</td>
                                        <td><Span class="text-danger">A)</Span> memimpin pelaksanaan administrasi akademik dan kemahasiswaan, data dan informasi institut.</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td><span class="text-danger">B)</span> memimpin pelaksanaan tridarma perguruan tinggi.</td>
