<x-app-layout title="Form Penilaian Rektor | StaffSus Bidang Kerjasama">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">StaffSus Bidang Kerjasama</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('StaffSusBidKerjasama.raport', Auth::user()->id) }}" class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
                <a href="{{ route('edit.StaffSusBidKerjasama', Auth::user()->id) }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.StaffSusBidKerjasama') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Melakukan pengembangan usaha pendukung yang dapat di implementasikan dan dikerjasamakan dengan pihak lain untuk
                                        menunjang peningkatan pendapatan institusi diluar penerimaan mahasiswa</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* Proposal pengembangan usaha</label>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Melakukan riset kebutuhan civitas akademika dalam pemenuhan usaha yang akan di kembangkan</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* Dokumen riset</label>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Menjalain Kerjasama dengan unit lain untuk menunjung kebijakan yang akan dikeluarkan sehubungan dengan usaha yang sedang
                                        di kembangkan oleh institusi</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* Proposal dari unit lain dilingkungan IKBIS</label>
                                    ...
                                    <tr>
                                        <td>4.</td>
                                        <td>Membuat penawaran dan kontrak Kerjasama denganpihak lain untukmenunjang perencanaan usaha yang telah di setujui oleh
                                        institusi</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* MoU/MoA</label>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Melakukan riset dan evaluasi terhadap usaha yang telah diimplemantasikan</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* Monev usaha yang sudah berjalan</label>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Menyusun laporan unit Kerjasama sebagai pertanggung jawaban kepada atasan</td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/rektor/staffsusbidkerjasama/PointKinerjaPerilaku.js') }}"></script>
    <script src="{{ asset('Assets/js/itisar/rektor/staffsusbidkerjasama/PointKinerjaKompetensi.js') }}"></script>
