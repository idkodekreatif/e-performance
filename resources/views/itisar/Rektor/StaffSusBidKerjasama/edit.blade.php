<x-app-layout title="Edit Penilaian Rektor | StaffSus Bidang Kerjasama">
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('StaffSusBidKerjasama.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
            </div>
        </div>
        <form action="{{ route('update.StaffSusBidKerjasama', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
