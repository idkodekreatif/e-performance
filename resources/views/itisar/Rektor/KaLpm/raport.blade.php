<x-app-layout title="Raport Penilaian Rektor | Ka. Lpm">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Raport Ka. Lpm</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('KaLpm') }}" class="btn btn-primary btn-sm mb-2 float-end">Point</a>
            </div>
        </div>
