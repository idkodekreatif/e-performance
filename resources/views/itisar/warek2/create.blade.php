    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.warek2.ka.bau') }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.warek2.ka.bau') }}" id="my-form" method="POST" enctype="multipart/form-data">
            @csrf
