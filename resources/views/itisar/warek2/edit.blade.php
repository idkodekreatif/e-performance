<x-app-layout title="Edit Penilaian warek 2 | Ka. Bau">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.warek2.ka.bau', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
