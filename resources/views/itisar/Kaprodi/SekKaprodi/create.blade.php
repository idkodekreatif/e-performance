<x-app-layout title="Form Penilaian Sek Ka. Prodi">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Sek Ka. Prodi</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('sekKaprodi.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
                <a href="{{ route('edit.sekKaprodi', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.sekKaprodi') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Membantu Ketua Program Studi dalam melaksanakan penyelenggaraan pendidikan, penelitian, pengabdian kepada masyarakat</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Memaraf surat-surat dinas sesuai ketentuan</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Mengkoordinasikan dan melaksanakan rencana pengembangan studi lanjut dan pelatihan dosen</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Mengkoordinasikan dan melaksanakan penetapkan dosen pengampu mata kuliah berdasarkan kesesuaian antara bidang ilmu
                                        dengan mata kuliah yang diasuh</td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Mengkoordinasikan dan melaksanakan sosialisasi, penyusunan, pengembangan serta evaluasi kurikulum dan silabus serta
                                        Satuan Acara Perkuliahan (SAP) program studi</td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Mengkoordinasikan dan melaksanakan pengawasan dan evaluasi Proses Belajar Mengajar (PBM) pada aplikasi INGEL
                                        </td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Mengkoordinasikan dan melaksanakan penyusunan spesifikasi program studi dan kompetensi lulusan
                                        </td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Mengkoordinasikan dan melaksanakan penetapkan judul skripsi mahasiswa, dosen pembimbing serta pembimbing praktikum
                                        </td>
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td>Mengkoordinasikan dan melaksanakan penetapan pembimbing akademik
                                        </td>
                                    ...
                                    <tr>
                                        <td>11</td>
                                        <td>Mengkoordinasikan dan melaksanakan rencana pembukaan program studi baru sesuai kebutuhan jaman
                                        </td>
                                    ...
                                    <tr>
                                        <td>12</td>
                                        <td>Mengkoordinasikan dan mekaksanakan rekruitmen tenaga pengajar baru dalam hal keahlian dan pendidikan
                                        </td>
                                        <td><input type="radio" class="kinerja_kompetensi_10"
                                    ...
                                    <tr>
                                        <td>13</td>
                                        <td>Mengkoordinasikan dan Mengatur beban kerja dosen secara adil dan porposional sesuai dengan keahlian dan kinerja dosen
                                        </td>
                                    ...
                                    <tr>
                                        <td>14</td>
                                        <td>Mengkoordinasikan dan melaksanakan penyusunan daftar kebutuhan buku referensi dan peralatan Laboratorium
                                        </td>
                                    ...
                                    <tr>
                                        <td>15</td>
                                        <td>Mengkoordinasikan da melaksanakan pengawasan berjenjang dan melekat dalam rangka pembinaan terhadap dosen
                                        </td>
                                    ...
                                    <tr>
                                        <td>16</td>
                                        <td>Menyusun laporan Sek. Prodi sebagai pertanggung jawaban kepada atasan
                                        </td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/Kaprodi/SekKaprodi/PointKinerjaPerilaku.js') }}"></script>
    <script src="{{ asset('Assets/js/itisar/Kaprodi/SekKaprodi/PointKinerjaKompetensi.js') }}"></script>
