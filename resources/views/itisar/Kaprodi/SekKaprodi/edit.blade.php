<x-app-layout title="Edit Penilaian Sek Ka. Prodi">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.sekKaprodi', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
