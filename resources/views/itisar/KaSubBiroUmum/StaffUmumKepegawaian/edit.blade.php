<x-app-layout title="Edit Penilaian Staff Umum Dan Kepegawaian">
    @push('style')
    <style>
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('staffumum.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
            </div>
        </div>
        <form action="{{ route('update.staffumum', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>MMemberikan lembar disposisi pada surat-surat masuk dan menyerahkan kepada Wakil Rektor I & II</td>
