    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.staffumum') }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.staffumum') }}" id="my-form" method="POST" enctype="multipart/form-data">
            @csrf
