<x-app-layout title="Form Penilaian Staff Umum Dan Kepegawaian">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Staff Umum Dan Kepegawaian</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('staffumum.raport', Auth::user()->id) }}" class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
                <a href="{{ route('edit.staffumum', Auth::user()->id) }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.staffumum') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Menerima Telepon masuk dengan memperhatikan etika yang berlaku</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Memberikan lembar disposisi pada surat-surat masuk dan menyerahkan kepada Wakil Rektor I & II</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Membuka laman LLDIKTI Wil. VII setiap hari kerja untuk mengetahui informasi penting (khususnya undangan-undangan yang
                                        mendesak)</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Mengantarkan tamu ke Pejabat Struktural, Dosen dan tendik</td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/SubBiroUmum/StaffUmum/PointKinerjaPerilaku.js') }}"></script>
    <script src="{{ asset('Assets/js/itisar/SubBiroUmum/StaffUmum/PointKinerjaKompetensi.js') }}"></script>
