<x-app-layout title="Edit Penilaian Ka. Upt | Ka. UNIT PEMASARAN">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.ka.pemasaran', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
