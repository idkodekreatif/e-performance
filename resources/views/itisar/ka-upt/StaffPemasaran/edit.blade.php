<x-app-layout title="Edit Penilaian Staff Pemasaran">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.StaffPemasaran', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
