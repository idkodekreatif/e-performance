<x-app-layout title="Form Penilaian Warek 1 | Koor Kemahasiswaan Dan Alumni">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Koor Kemahasiswaan Dan Alumni</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('koorkemahasiswaanDanAlumni.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
                <a href="{{ route('edit.koorkemahasiswaanDanAlumni', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.koorkemahasiswaanDanAlumni') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Melaksanakan dan Mengoordinasikan kegiatan Organisasi Mahasiswa (ORMAWA) meliputi minat, khusus, penalaran, layanan
                                        kesejahteraan dan layanan informasi mahasiswa</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* Proposal</label>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Melaksanakan dan Mengoordinasikan penerimaan beasiswa bagi mahasiswa</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Melaksanakan dan Mengoordinasikan pengelolaan data alumni</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Melaksanakan dan Mengoordinasikan pelaksanaan kegiatan penelitian mahasiswa</td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Melaksanakan dan Mengoordinasikan Program Mahasiswa Wirausaha (PMW)</td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Melaksanakan dan Mengoordinasikan Pengembangan Softskill mahasiswa
                                        </td>
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Melaksanakan dan Mengoordinasikan Kegiatan Pengenalan Kehidupan Kampus bagi Mahasiswa Baru (PKKMB)
                                        </td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Melaksanakan dan Mengoordinasikan Monitoring dan Evaluasi Internal Program Kreativitas Mahasiswa (PKM)
                                        </td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Melaksanakan dan Mengoordinasikan seleksi Mahasiswa Berprestasi (MAPRES) tingkat institut
                                        </td>
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td>Mengumpulkan, mengolah dan menganalisis data di bidang kegiatan kemahasiswaan
                                        </td>
                                    ...
                                    <tr>
                                        <td>11</td>
                                        <td>Melaksanakan dan Mengoordinasikan kegiatan pembinaan penalaran, minat organisasi dan kesejahteraan di bidang
                                        kemahasiswaan
                                        </td>
                                    ...
                                    <tr>
                                        <td>12</td>
                                        <td>Melaksanakan dan Mengoordinasikan seminar, penataran, lokakarya, temu ilmiah mahasiswa dan alumni
                                        </td>
                                        <td><input type="radio" class="kinerja_kompetensi_10"
                                    ...
                                    <tr>
                                        <td>13</td>
                                        <td>Menyusun informasi di bidang kemahasiswaan dan hubungan alumni sebagai bahan penyusunan kebijakkan pimpinan
                                        </td>
                                    ...
                                    <tr>
                                        <td>14</td>
                                        <td>Melaksanakan dan Mengoordinasikan sistem administrasi dan stastistik mahasiwa dan alumni
                                        </td>
                                    ...
                                    <tr>
                                        <td>15</td>
                                        <td>Mengarsipkan dokumen dan surat-surat di bidang kemahasiswaan dan alumni
                                        </td>
                                    ...
                                    <tr>
                                        <td>16</td>
                                        <td>Menyusun laporan Ka. Sub Biro Kemahasiswaan dan Alumni sebagai pertanggung jawaban kepada atasan
                                        </td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/warekSatu/kemahasiswaanDanAlumni/PointKinerjaPerilaku.js') }}"></script>
    <script src="{{ asset('Assets/js/itisar/warekSatu/kemahasiswaanDanAlumni/PointKinerjaKompetensi.js') }}"></script>
