<x-app-layout title="Edit Penilaian Warek 1 | Koor Kemahasiswaan Dan Alumni">
    @push('style')
    <style>
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.koorkemahasiswaanDanAlumni', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
