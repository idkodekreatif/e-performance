    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Data Search Koor Kemahasiswaan Dan Alumni</a>
                </li>
            </ol>
        </div>
        {{-- <div class="row">
        ...
        <form action="{{ route('resultRaport.koorkemahasiswaanDanAlumni') }}" method="GET">
