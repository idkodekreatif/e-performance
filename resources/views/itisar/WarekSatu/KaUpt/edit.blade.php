<x-app-layout title="Edit Penilaian Warek 1 | Ka. Upt">
    @push('style')
    <style>
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.WarekSatu.Ka.Upt', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
