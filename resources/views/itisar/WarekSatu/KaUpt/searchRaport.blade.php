<x-app-layout title="Search Data Ka. Upt">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Raport Search Ka. Upt</a></li>
            </ol>
        </div>
        {{-- <div class="row">
            <div class="col">
        ...
        <form action="{{ route('resultRaport.WarekSatu.Ka.Upt') }}" method="GET">
