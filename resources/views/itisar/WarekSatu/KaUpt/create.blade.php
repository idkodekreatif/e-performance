<x-app-layout title="Form Penilaian Warek 1 | Ka. Upt">
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('store.WarekSatu.Ka.Upt') }}" id="my-form" method="POST"
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Mengkoordinir pelaksanaan kegiatan operasional unit pemasaran, unit
                                            perpustakaan, unit informasi dan teknologi, unit
                                            laboratorium</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Mengawasi terlaksananya tugas pokok dan fungsi dari unit pemasaran, unit
                                            perpustakaan, unit informasi dan teknologi unit
                                            laboratorium</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Menyusun laporan unit pelaksana teknis sebagai pertanggung jawaban kepada
                                            atasan;</td>
