<x-app-layout title="Form Penilaian Warek 1 | Ka. Upt">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Ka. Upt</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('WarekSatu.Ka.Upt.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
                <a href="{{ route('edit.WarekSatu.Ka.Upt', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.WarekSatu.Ka.Upt') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Mengkoordinir pelaksanaan kegiatan operasional unit pemasaran, unit perpustakaan, unit informasi dan teknologi, unit
                                        laboratorium</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Mengawasi terlaksananya tugas pokok dan fungsi dari unit pemasaran, unit perpustakaan, unit informasi dan teknologi unit
                                        laboratorium</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Menyusun laporan unit pelaksana teknis sebagai pertanggung jawaban kepada atasan;</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Menyusun rencana kerja dan anggaran tahunan (RKAT).</td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/warekSatu/KaUpt/PointKinerjaPerilaku.js') }}"></script>
    <script src="{{ asset('Assets/js/itisar/warekSatu/KaUpt/PointKinerjaKompetensi.js') }}"></script>
