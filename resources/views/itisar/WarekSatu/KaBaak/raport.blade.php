<x-app-layout title="Raport Penilaian Warek Satu | Ka. Baak">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('WarekSatu.Ka.Baak') }}" class="btn btn-primary btn-sm mb-2 float-end">Point</a>
            </div>
        </div>
        <div class="card shadow">
            <div class="card-header">
                <h4 class="card-title">Raport Ka. Baak</h4>
            </div>
            <div class="card-body">
