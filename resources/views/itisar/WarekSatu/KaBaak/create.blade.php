<x-app-layout title="Form Penilaian Warek Satu | Ka. Baak">
    @push('style')
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('WarekSatu.Ka.Baak.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
                <a href="{{ route('edit.WarekSatu.Ka.Baak', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.WarekSatu.Ka.Baak') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Menghimpun dan mengkaji peraturan perundang-undangan di bidang Akademik dan Kemahasiswaan</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* Dokumen peraaturan perundang-undangan di bidang akademik dan kemahasiswaan</label>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Mengkoordinasikan dan melaksanakan administrasi akademik dan kemahasiswaan</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Mengkoordinasikan penyusunan Kalender Akademik</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* dokumen kaldik</label>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Melaksanakan penyusunan data daya tampung mahasiswa</td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* dokumen daya tampung mhs</label>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Membuat SOP Registrasi bagi mahasiswa
                                        </td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* dokumen SOP</label>
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Membuat dan menyediakan transkrip nilai, ijazah dan SKPI
                                        </td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Menyusun rencanan pelaksanaan wisuda
                                        </td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Mengkoordinasikan Kegiatan Pengenalan Kehidupan Kampus bagi Mahasiswa Baru (PKKMB)
                                        </td>
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td>Penyusunan informasi akademik dan kemahasiswaan untuk Pangkalan Data Pendidikan Tinggi (PDPT) Dirjen Pendidikan Tinggi
                                        untuk menunjang akreditasi Institusi dan Program Studi
                                        </td>
                                        ...
                                        @enderror
                                        <td>
                                            <label for="formFileSm" class="form-label text-danger">* cek fisik PDPT</label>
                                    ...
                                    <tr>
                                        <td>11</td>
                                        <td>Melaksanakan administrasi akademik dan kemahasiswaan
                                        </td>
                                    ...
                                    <tr>
                                        <td>12</td>
                                        <td>Mengkoordinasikan kegiatan pembinaan bidang kemahasiswaan;
                                        </td>
                                        <td><input type="radio" class="kinerja_kompetensi_10"
                                    ...
                                    <tr>
                                        <td>13</td>
                                        <td>Menyusun laporan BAAK sebagai pertanggung jawaban kepada atasan
                                        </td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/warekSatu/KaBaak/PointKinerjaPerilaku.js') }}"></script>
    <script src="{{ asset('Assets/js/itisar/warekSatu/KaBaak/PointKinerjaKompetensi.js') }}"></script>
