<x-app-layout title="Form Penilaian Rektor | Ka. Prodi">
    @push('style')
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.WarekSatu.Ka.Prodi', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.WarekSatu.Ka.Prodi') }}" method="POST" enctype="multipart/form-data">
            @csrf
