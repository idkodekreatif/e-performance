<x-app-layout title="Edit Penilaian Warek Satu | Ka. Risbang">
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.WarekSatu.Ka.Risbang', ['pointId' => $data->user_id]) }}" id="my-form"
                            ...
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-primary">
                                        ...
                                        <td colspan="8 text-center"></td>
                                    </tr>

                                    <tr>
                                        <td>A</td>
                                        <td>Penyelenggaran penelitian dan pengabdian
                                            masyarakat
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>B</td>
                                        <td>isi dari jurnal penelitian yang telah
                                    ...
                                    <tr>
                                        <td>D</td>
                                        <td>mutu penelitian dosen dan mahasiswa di
                                            lingkungan lembaga
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>26</td>
                                        <td>Mmencari informasi pendanaan untuk penelitian dan pengabdian masyarakat dari
