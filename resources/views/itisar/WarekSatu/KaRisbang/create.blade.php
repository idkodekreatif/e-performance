<x-app-layout title="Form Penilaian Warek Satu | Ka. Risbang">
    @push('style')
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.WarekSatu.Ka.Risbang') }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.WarekSatu.Ka.Risbang') }}" id="my-form" method="POST"
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Mengkoordinasikan penyelenggaraan Tri Dharma Perguruan Tinggi yaitu Dharma
                                            Penelitian, Pengabdian masyarakat di
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Menyiapkan sarana penelitian dan pengabdian masyarakat di lingkungan
                                            institute</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Mengkoordinasikan,merancang dan membangun model kerjasama dalam bidang
                                            penelitian dan pengabdian kepada masyarakat baik
                                            dengan instansi pemerintah, swasta, perorangan maupun lembaga kemasyarakatan
                                            lainnya</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Memotivasi dosen dan mahasiswa dalam berbagai topic penelitian terpadu dan
                                            pengabdian masyarakat</td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Membuat roadmap penelitian dan pengmas yang sesuai dengan kebutuhan lembaga
                                        </td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Bertanggung jawab terhadap pelaksanaan pengabdian masyarakat yang
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Menyeleksi bahan penelitian yang akan diterbitkan di jurnal institusi dan
                                            jurnal prodi
                                        </td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Menentukan dan menyeleksi usulan proposal penelitian dan pengabdian
                                            masyarakat dilingkungan lembaga
                                        </td>
                                    ...
                                    <tr class="table-primary">
                                        <td>10</td>
                                        <td>Bertanggung jawab terhadap</td>
                                        <td colspan="7"></td>
                                    </tr>
                                    <tr>
                                        <td>A</td>
                                        <td>Penyelenggaran penelitian dan
                                    ...
                                    <tr>
                                        <td>B</td>
                                        <td>isi dari jurnal penelitian yang
                                            telah dan akan diterbitkan
                                        </td>
                                    ...
                                    <tr>
                                        <td>C</td>
                                        <td>rencana kerja dan anggran tahunan
                                            beserta dengan penggunaan anggaran
                                        </td>
                                        <td><input type="radio" class="kinerja_kompetensi_10"
                                    ...
                                    <tr>
                                        <td>D</td>
                                        <td>mutu penelitian dosen dan mahasiswa
                                    ...
                                    <tr>
                                        <td>11</td>
                                        <td>Melakukan dokumentasi dan/atau publikasi hasil-hasil penelitian dan
                                            pengabdian masyarakat
                                        </td>
                                    ...
                                    <tr>
                                        <td>12</td>
                                        <td>Melakukan koordinasi dengan Ketua Prodi dan Tim Penilai Angka Kredit (TPAK)
                                            dalam proses dokumentasi dan penghitungan
                                    ...
                                    <tr>
                                        <td>13</td>
                                        <td>Menyusun Rencana Induk Penelitian dan Pengabdian masyarakat berdasarkan Road
                                            Map Penelitian dan pengabdian masyarakat
                                            dan mengembangkan payung penelitian dan Pengabdian masyarakat berbasis IPTEK
                                            serta menentukan arah Penelitian dan
                                            Pengabdian Masyarakat;
                                        </td>
                                    ...
                                    <tr>
                                        <td>14</td>
                                        <td>Menetapkan rumusan informasi hasil Penelitian dan KKM berdasarkan ketentuan
                                            yang berlaku untuk diketahui oleh
                                            masyarakat.
                                        </td>
                                    ...
                                    <tr>
                                        <td>15</td>
                                        <td>Menetapkan kriteria dan menelaah makalah ilmiah sesuai dengan jenisnya
                                            sebagai bahan publikasi untuk jurnal ilmiah
                                        </td>
                                    ...
                                    <tr>
                                        <td>16</td>
                                        <td>Menyusun, merencanakan, mengembangkan dan mengendalikan fasilitas dan
                                            seluruh sumber daya RISBANG sesuai pedoman Lembaga
                                            Penjaminan Mutu;
                                        </td>
                                    ...
                                    <tr>
                                        <td>17</td>
                                        <td>Mempublikasikan dan melakukan sosialisasi kepada sivitas academica tentang
                                            program RISBANG
                                        </td>
                                    ...
                                    <tr>
                                        <td>18</td>
                                        <td>Mengkoordinasikan kegiatan seminar proposal dan seminar hasil penelitian dan
                                            pengabdian masyarakat;
                                        </td>
                                    ...
                                    <tr>
                                        <td>19</td>
                                        <td>Menilai usulan penelitian dan pengabdian masyarakat yang masuk sesudah
                                            disaring di tingkat prodi, dilihat dari segi mutu
                                            dan anggaran
                                        </td>
                                    ...
                                    <tr>
                                        <td>21</td>
                                        <td>Membantu meningkatkan mutu penelitian dan pengabdian masyarakat dengan
                                            mengadakan penataran/workshop/klinik proposal
                                    ...
                                    <tr>
                                        <td>22</td>
                                        <td>Membantu menanggulangi masalah-masalah dalam pelaksanaan penelitian dan
                                    ...
                                    <tr>
                                        <td>23</td>
                                        <td>Membantu dosen dan mahasiswa dalam hal etika, tema-tema dan metodologi
                                            penelitian, serta HAKI Penelitian dan pengabdian
                                            masyarakat
                                        </td>
                                    ...
                                    <tr>
                                        <td>24</td>
                                        <td>Membantu kerjasama antar dosen, antar mahasiswa dan antar prodi untuk
                                            melakukan kajian-kajian lintas disiplin ilmu
                                        </td>
                                    ...
                                    <tr>
                                        <td>25</td>
                                        <td>Membantu dosen dalam publikasi hasil penelitian dan pengabdian masyarakat,
                                            buku ajar, dan luaran lainnya
                                        </td>
                                    ...
                                    <tr>
                                        <td>26</td>
                                        <td>mencari informasi pendanaan untuk penelitian dan pengabdian masyarakat dari
                                            kemenristekdikti, instansi pemerintah
                                    ...
                                    <tr>
                                        <td>27</td>
                                        <td>Mengembangkan jaringan kerjasama penelitian dan pengabdian masyarakat dengan
                                            berbagai Perguruan Tinggi lainnya
                                        </td>
