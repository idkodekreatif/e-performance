    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.WarekSatu.Ka.Risbang', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.WarekSatu.Ka.Risbang') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td><span class="text-danger">A. </span> Penyelenggaran penelitian dan pengabdian masyarakat
                                        </td>
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td><span class="text-danger">B. </span> b. isi dari jurnal penelitian yang telah dan akan diterbitkan
                                        </td>
                                    ...
                                    <tr>
                                        <td>26</td>
                                        <td>mencari informasi pendanaan untuk penelitian dan pengabdian masyarakat dari kemenristekdikti, instansi pemerintah
