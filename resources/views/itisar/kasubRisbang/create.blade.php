<x-app-layout title="Form Penilaian Kasub Risbang">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Kasub Risbang</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('KasubRisbang.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
                <a href="{{ route('edit.KasubRisbang', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.KasubRisbang') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Memberikan layanan peningkatan kemampuan dan pengembangan bagi Dosen, Mahasiswa, dan Tenaga Kependidikan.</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Memberikan layanan tes dan sertifikasi kemampuan dalam sebuah desain penelitian bagi Dosen, Mahasiswa, dan Tenaga
                                        Kependidikan.</td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Mengelola jurnal Penelitian dan Pengabdian Kepada Masyarakat.</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Melaksanakan kegiatan administrasi penerbitan jurnal pada program studi di lingkungan Institut.</td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Menyelenggarakan kegiatan publikasi hasil penelitian dan Pengabdian Masyarakat bagi dosen dan mahasiswa</td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Memfasilitasi dosen dan mahasiswa dalam pelaksanaan pengurusan HKI.
                                        </td>
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Memberikan informasi kepada dosen dan mahasiswa tentang berbagai hal yang berguna bagi pengembangan pribadi, sosial,
                                        studi dan karier.
                                        </td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Memberikan pelatihan kepada dosen dan mahasiswa secara kelompok untuk pengembangan pribadi, sosial, studi, dan karier.
                                        </td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Sebagai bagian dari pengelolaan sistem data dan sistem informasi yang terkait dengan website yang menunjang penelitian
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td>Menyusun laporan Ka. Sub. Lem. Penelitian dan pengmas sebagai pertanggung jawaban kepada atasan
                                        </td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/KasubRisbang/PointKinerjaPerilaku.js') }}"></script>
    <script src="{{ asset('Assets/js/itisar/KasubRisbang/PointKinerjaKompetensi.js') }}"></script>
