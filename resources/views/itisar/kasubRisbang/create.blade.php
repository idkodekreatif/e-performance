    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.KasubRisbang') }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Memberikan layanan peningkatan kemampuan dan pengembangan bagi Dosen,
                                            Mahasiswa, dan Tenaga Kependidikan.</td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Memberikan layanan tes dan sertifikasi kemampuan dalam sebuah desain
                                            penelitian bagi Dosen, Mahasiswa, dan Tenaga
                                            Kependidikan.</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Melaksanakan kegiatan administrasi penerbitan jurnal pada program studi di
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Menyelenggarakan kegiatan publikasi hasil penelitian dan Pengabdian
                                            Masyarakat bagi dosen dan mahasiswa</td>
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Memberikan informasi kepada dosen dan mahasiswa tentang berbagai hal yang
                                            berguna bagi pengembangan pribadi, sosial,
                                            studi dan karier.
                                        </td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Memberikan pelatihan kepada dosen dan mahasiswa secara kelompok untuk
                                            pengembangan pribadi, sosial, studi, dan karier.
                                        </td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Sebagai bagian dari pengelolaan sistem data dan sistem informasi yang
                                            terkait dengan website yang menunjang penelitian
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td>Menyusun laporan Ka. Sub. Lem. Penelitian dan pengmas sebagai pertanggung
