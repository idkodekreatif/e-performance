<x-app-layout title="Edit Penilaian Ka. Sub. Biro Keuangan & Akuntansi">
    @push('style')
        <style>
    ...
    <div class="col-xl col-lg">
        ...
        {{-- <div class="row">
            <div class="col">
                <a href="{{ route('KasubBiroKeuangan.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a>
            </div>
        </div> --}}
        <form action="{{ route('update.KasubBiroKeuangan', ['pointId' => $data->user_id]) }}" id="my-form" method="POST"
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Mengkoordinasikan pelaksanaan pengumpulan, mengolah dan menganalisis data
                                            untuk RAB, revisi RAB dan usulan pengelola
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Mengkoordinasikan pelaksanaan penyusunan juknis pengelolaan keuangan dan
                                            pedoman akuntansi serta pelaporan</td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Mengkoordinasikan pelaksanaan penerimaan, penyimpanan, penggunaan, dan
                                            pertanggungjawaban keuangan</td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Mengkoordinasikan pelaksanaan penelitian dan pengujian kebenaran, bukti
                                            penerimaan dan pengeluaran dana dan pengujian
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Mengkoordinasikan dan menyelenggarakan pembukuan/akuntansi dan pelaporan
                                            keuangan</td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Mengoordinasikan penyelenggaraan layanan administrasi dan evaluasi
                                            penerimaan, pencairan dana dan pelaporan keuangan
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Mengkoodinasikan dan melaksanakan layanan informasi keuangan yang diperlukan
                                            oleh Satuan Unit kerja
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Mengoordinasikan penyelenggaraan layanan konsultasi data dan informasi
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Mengkoordinasikan pengumpulan data dan pelaporan keuangan untuk pengambilan
                                    ...
                                    <tr>
                                        <td>12</td>
                                        <td>Melaksanakan pengumpulan Surat Perintah Pencairan Dana (SP2D), dan Lain-lain
                                            yang diperlukan untuk data Sistem Akuntansi
                                        </td>
                                        <td><input type="radio"
