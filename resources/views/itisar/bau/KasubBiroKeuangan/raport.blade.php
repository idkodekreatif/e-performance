<x-app-layout title="Raport Penilaian Ka. Sub. Biro Keuangan & Akuntansi">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Raport Ka. Sub. Biro Keuangan & Akuntansi</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('KasubBiroKeuangan') }}" class="btn btn-primary btn-sm mb-2 float-end">Point</a>
            </div>
        </div>
        <div class="card shadow">
            <div class="card-header">
                <h4 class="card-title">Raport Ka. Sub. Biro Keuangan & Akuntansi</h4>
            </div>
            <div class="card-body">
