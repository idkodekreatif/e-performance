<x-app-layout title="Raport Penilaian Ka. Sub. Biro Kepegawaian">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Raport Ka. Sub. Biro Kepegawaian</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
        ...
        <div class="card shadow">
            <div class="card-header">
                <h4 class="card-title">Raport Ka. Sub. Biro Kepegawaian</h4>
            </div>
            <div class="card-body">
