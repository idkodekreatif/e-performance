<x-app-layout title="Edit Penilaian Ka. Sub. Biro Kepegawaian">
    @push('style')
        <style>
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Ka. Sub. Biro Kepegawaian</a></li>
            </ol>
        </div>
        {{-- <div class="row">
            <div class="col">
        ...
        <form action="{{ route('update.kasubBiroKepegawaian', ['pointId' => $data->user_id]) }}" id="my-form"
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Mengumpulkan, mengolah dan menganalisis data tatausaha kearsipan,
                                            kerumahtanggaan, sarpras serta kepegawaian</td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Menyusun peraturan dan ketentuan di bidang ketatausahaan kearsipan,
                                            kerumahtanggaan, sarpras dan kepegawaian</td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Menyiapkan segala sesuatu berkaitan dengan pelaksanaan rapat dan acara-acara
                                            ceremonial</td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Mengkoordinasikan pelaksanaan kebersihan, keamanan dan pemanfaatan sarpras
                                            di lingkungan IKBIS
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Melaksanakan pengadministrasian perjalanan dinas pegawai dan penggunaan
                                            kendaraan dinas
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Melaksanakan dan Mengkoordinasikan penyimpanan, pendistribusian,
                                            inventarisasi, dan penghapusan barang milik Institusi
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td>Menyusun instrumen pemantauan kegiatan tatausaha, kerumahtanggaan, sarpras
                                            dan kepegawaian
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>11</td>
                                        <td>Melaksanakan dan Mengkoordinasikan sistem jenjang kepangkatan, mutasi,
                                    ...
                                    <tr>
                                        <td>12</td>
                                        <td>Melaksanakan dan Mengkoordinasikan pelaksanaan Penilaian kinerja dosen dan
                                            tendik, Menyusun Daftar Urut Kepangkatan
                                    ...
                                    <tr>
                                        <td>13</td>
                                        <td>Melaksanakan dan mengkoordinasikan administrasi BPJS kesehatan dan
                                            ketenagakerjaan
                                        </td>
                                        <td><input type="radio"
                                    ...
                                    <tr>
                                        <td>14</td>
                                        <td>Menyusun laporan Ka. Sub. Biro Umum, protokol dan kepegawaian sebagai
