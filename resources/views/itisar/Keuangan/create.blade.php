<x-app-layout title="Form Penilaian Keuangan">
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.StaffKeuangan', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.StaffKeuangan') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Mengkoodinasikan dan melaksanakan layanan informasi keuangan yang diperlukan oleh Satuan Unit kerja</td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Mengoordinasikan penyelenggaraan layanan konsultasi data dan informasi keuangan pada mahasiswa</td>
    ...
    @push('JavaScript')
    <script src="{{ asset('Assets/js/itisar/StaffKeuangan/PointKinerjaPerilaku.js') }}"></script>
