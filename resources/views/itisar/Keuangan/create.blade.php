<x-app-layout title="Form Penilaian Keuangan">
    @push('style')
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                {{-- <a href="{{ route('StaffKeuangan.raport', Auth::user()->id) }}"
                    class="btn btn-primary btn-sm mb-2 float-end">Raport</a> --}}
                <a href="{{ route('edit.StaffKeuangan') }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
        <form action="{{ route('store.StaffKeuangan') }}" id="my-form" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Menyusun laporan keuangan sebagai pertanggung jawaban kepada atasan
                                        </td>
    ...
    @push('JavaScript')
        ...
        <script src="{{ asset('Assets/js/itisar/StaffKeuangan/PointKinerjaKompetensi.js') }}"></script>
