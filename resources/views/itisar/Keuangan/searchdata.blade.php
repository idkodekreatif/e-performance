<x-app-layout title="Search Data Keuangan">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Data Search Keuangan</a></li>
            </ol>
        </div>
        {{-- <div class="row">
            <div class="col">
        ...
        <form action="{{ route('staffkeuangan.data.search') }}" method="GET">
