    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="{{ route('edit.rektor') }}" class="btn btn-primary btn-sm mb-2 mr-2 float-end">Edit</a>
            </div>
        </div>
                        ...
                        <div class="table table-responsive table-bordered">
                            <table class="table table-responsive table-bordered border-2 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Melaksanakan fungsi perencanaan, koordinasi dan control institut khususnya
                                            pada bidang tridarma perguruan tinggi</td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Mengkoordinasikan dan memimpin pelaksanaan akreditasi institusi dan prodi
                                        </td>
                                    ...
                                    <tr>
                                        <td>A</td>
                                        <td>Mjalannya penyelenggaraan institut
                                            secara menyeluruh
                                        </td>
                                    ...
                                    <tr>
                                        <td>B</td>
                                        <td>pencapaian kinerja Institut sesuai
                                            yang ditargetkan dalam program kerja
                                        </td>
                                    ...
                                    <tr>
                                        <td>C</td>
                                        <td>hubungan antar lembaga terkait,
                                            misalnya LLDIKTI Wilayah 7, Yayasan, dan dewan penyantun serta
