<x-app-layout title="Edit Penilaian Rektor">
    @push('style')
    <style>
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('update.rektor', ['pointId' => $data->user_id]) }}" id="my-form" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
