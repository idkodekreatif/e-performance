<x-app-layout title="Iktisar Bulanan || Warek II">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Unit Warek II</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col">
                <a href="{{ route('iktisar.bulanan.warekDua.data.raport') }}" class="btn btn-primary btn-sm mb-2">Search
                    Raport</a>
                <a href="{{ route('iktisar.bulanan.warekDua.DataEdit') }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Search Edit</a>
            </div>
        </div>
        <form action="{{ route('iktisar.bulanan.warekDua.store') }}" id="my-form" method="POST"
