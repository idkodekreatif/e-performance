<x-app-layout title="Search Rekap Data Staff">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Rekap Data</a></li>
                <li class="breadcrumb-item"><a href="javascript:void(0)">Search</a></li>
            </ol>
        </div>

        <form action="{{ route('warek-dua.data.kaunit.report') }}" method="GET">
