<x-app-layout title="Iktisar Bulanan || Rektor">
    @push('style')
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('iktisar.bulanan.rektor.data.raport') }}" class="btn btn-primary btn-sm mb-2">Search
                    Raport</a>
                <a href="{{ route('iktisar.bulanan.rektor.DataEdit') }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Search Edit</a>
            </div>
        </div>
        <form action="{{ route('iktisar.bulanan.rektor.store') }}" id="my-form" method="POST"
