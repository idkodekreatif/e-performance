<x-app-layout title="IKTISAR Bulanan || Staff">
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('iktisar.bulanan.marketing.data.raport') }}"
                    class="btn btn-primary btn-sm mb-2">Search
                    Raport</a>
                <a href="{{ route('iktisar.bulanan.marketing.DataEdit') }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Search Edit</a>
            </div>
        </div>
        <form action="{{ route('iktisar.bulanan.marketing.store') }}" id="my-form" method="POST"
