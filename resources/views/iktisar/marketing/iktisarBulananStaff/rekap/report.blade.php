                        ...
                        <table id="reportTable" class="table table-bordered text-center">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    @php
                                        $DataUserKinerjaPerilaku =
                                            (float) $item->output_total_sementara_kinerja_perilaku;
                                        $DataUserKinerjaKompetensi = (float) $item->total_nilai_presentase;
                                        $resultSumPerilakuKompetensi =
                                            $DataUserKinerjaPerilaku + $DataUserKinerjaKompetensi;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('marketing.report.detail', ['user_id' => $item->user_id, 'created_insert' => $item->created_insert]) }}"
                ...
                var table = $('#reportTable').DataTable({
                    ...
                    initComplete: function() {
                        ...
                        this.api().columns(6).every(function() {
                            var column = this;
                            var select = $(
                                    '<select class="form-select form-select-sm"><option value="">Filter Predikat</option></select>'
                                    )
