<x-app-layout title="IKTISAR Bulanan || Staff">
    ...
    <div class="col-xl col-lg">
        ...
        <form action="{{ route('iktisar.bulanan.staff.store') }}" id="my-form" method="POST" enctype="multipart/form-iktisarStaffBulananPerilaku">
            @csrf
                    ...
                    <table class="table table-responsive table-bordered border-2 text-center">
                        ...
                        <tbody>
                            ...
                            <tr class="table-primary">
                                ...
                                <td><input type="radio" class="q1" name="q1" id="q1_1" value="1" {{ $iktisarStaffBulananPerilaku->q1 == '1' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q1" name="q1" id="q1_2" value="2" {{ $iktisarStaffBulananPerilaku->q1 == '2' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q1" name="q1" id="q1_3" value="3" {{ $iktisarStaffBulananPerilaku->q1 == '3' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q1" name="q1" id="q1_4" value="4" {{ $iktisarStaffBulananPerilaku->q1 == '4' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q1" name="q1" id="q1_5" value="5" {{ $iktisarStaffBulananPerilaku->q1 == '5' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                @error('q1')
                            ...
                            <tr class="table-primary">
                                <td>Question 2</td>
                                <td>Integritas</td>
                                <td><input type="radio" class="q2" name="q2" id="q2_1" value="1" {{ $iktisarStaffBulananPerilaku->q2 == '1' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q2" name="q2" id="q2_2" value="2" {{ $iktisarStaffBulananPerilaku->q2 == '2' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q2" name="q2" id="q2_3" value="3" {{ $iktisarStaffBulananPerilaku->q2 == '3' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q2" name="q2" id="q2_4" value="4" {{ $iktisarStaffBulananPerilaku->q2 == '4' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q2" name="q2" id="q2_5" value="5" {{ $iktisarStaffBulananPerilaku->q2 == '5' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                @error('q2')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <tr class="table-primary">
                                <td>Question 3</td>
                                <td>Komitmen</td>
                                <td><input type="radio" class="q3" name="q3" id="q3_1" value="1" {{ $iktisarStaffBulananPerilaku->q3 == '1' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q3" name="q3" id="q3_2" value="2" {{ $iktisarStaffBulananPerilaku->q3 == '2' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q3" name="q3" id="q3_3" value="3" {{ $iktisarStaffBulananPerilaku->q3 == '3' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q3" name="q3" id="q3_4" value="4" {{ $iktisarStaffBulananPerilaku->q3 == '4' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q3" name="q3" id="q3_5" value="5" {{ $iktisarStaffBulananPerilaku->q3 == '5' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                @error('q3')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <tr class="table-primary">
                                <td>Question 4</td>
                                <td>Disiplin</td>
                                <td><input type="radio" class="q4" name="q4" id="q4_1" value="1" {{ $iktisarStaffBulananPerilaku->q4 == '1' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q4" name="q4" id="q4_2" value="2" {{ $iktisarStaffBulananPerilaku->q4 == '2' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q4" name="q4" id="q4_3" value="3" {{ $iktisarStaffBulananPerilaku->q4 == '3' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q4" name="q4" id="q4_4" value="4" {{ $iktisarStaffBulananPerilaku->q4 == '4' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q4" name="q4" id="q4_5" value="5" {{ $iktisarStaffBulananPerilaku->q4 == '5' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                @error('q4')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <tr class="table-primary">
                                <td>Question 5</td>
                                <td>Kerjasama</td>
                                <td><input type="radio" class="q5" name="q5" id="q5_1" value="1" {{ $iktisarStaffBulananPerilaku->q5 == '1' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q5" name="q5" id="q5_2" value="2" {{ $iktisarStaffBulananPerilaku->q5 == '2' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q5" name="q5" id="q5_3" value="3" {{ $iktisarStaffBulananPerilaku->q5 == '3' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q5" name="q5" id="q5_4" value="4" {{ $iktisarStaffBulananPerilaku->q5 == '4' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                <td><input type="radio" class="q5" name="q5" id="q5_5" value="5" {{ $iktisarStaffBulananPerilaku->q5 == '5' ? 'checked' : '' }} onclick="sumPoint();">
                                </td>
                                @error('q5')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <tr>
                                <td colspan="2"></td>
                                <td><label for="">Point 1</label><input id="output_point_1" name="output_point_1" type="number" value="{{ $iktisarStaffBulananPerilaku->output_point_1 }}" aria-label="output_point" readonly></td>
                                <td><label for="">Point 2</label><input id="output_point_2" name="output_point_2" type="number" value="{{ $iktisarStaffBulananPerilaku->output_point_2 }}" aria-label="output_point" readonly></td>
                                <td><label for="">Point 3</label><input id="output_point_3" name="output_point_3" type="number" value="{{ $iktisarStaffBulananPerilaku->output_point_3 }}" aria-label="output_point" readonly></td>
                                <td><label for="">Point 4</label><input id="output_point_4" name="output_point_4" type="number" value="{{ $iktisarStaffBulananPerilaku->output_point_4 }}" aria-label="output_point" readonly></td>
                                <td><label for="">Point 5</label><input id="output_point_5" name="output_point_5" type="number" value="{{ $iktisarStaffBulananPerilaku->output_point_5 }}" aria-label="output_point" readonly></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="table-primary">
                                    ...
                                    <input id="output_total_point_kinerja_perilaku" name="output_total_point_kinerja_perilaku" type="number" value="{{ $iktisarStaffBulananPerilaku->output_total_point_kinerja_perilaku }}" aria-label="output_total_point_kinerja_perilaku" readonly>
                                </td>
                                <td class="table-primary"><label for="">Nilai Rata-rata</label><input id="output_total_nilai_rata_rata_kinerja_perilaku" name="output_total_nilai_rata_rata_kinerja_perilaku" type="number" value="{{ number_format($iktisarStaffBulananPerilaku->output_total_nilai_rata_rata_kinerja_perilaku, 2) }}" aria-label="output_total_nilai_rata_rata_kinerja_perilaku" readonly>
                                </td>
                                <td class="table-primary"><label for="">Nilai Sementara</label><input id="output_total_sementara_kinerja_perilaku" name="output_total_sementara_kinerja_perilaku" type="number" value="{{ number_format($iktisarStaffBulananPerilaku->output_total_sementara_kinerja_perilaku, 2) }}" aria-label="output_total_sementara_kinerja_perilaku" readonly></td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="card-body">
            <div class="basic-form">
                ...
                <div class="col-md-6 mt-2">
                    <div class="row mt-3">
                        <div class="col-md">
                            <input type="radio" class="question" {{ $data->question == '1' ? 'checked' : '' }} name="question[{{ $key }}]" id="question1" value="1" onclick="sumQuestion();">
                        </div>
                        <div class="col-md">
                            <input type="radio" class="question" {{ $data->question == '2' ? 'checked' : '' }} name="question[{{ $key }}]" id="question2" value="2" onclick="sumQuestion();">
                        </div>
                        <div class="col-md">
                            <input type="radio" class="question" {{ $data->question == '3' ? 'checked' : '' }} name="question[{{ $key }}]" id="question3" value="3" onclick="sumQuestion();">
                        </div>
                        <div class="col-md">
                            <input type="radio" class="question" {{ $data->question == '4' ? 'checked' : '' }} name="question[{{ $key }}]" id="question4" value="4" onclick="sumQuestion();">
                        </div>
                        <div class="col-md">
                            <input type="radio" class="question" {{ $data->question == '5' ? 'checked' : '' }} name="question[{{ $key }}]" id="question5" value="5" onclick="sumQuestion();">
                        </div>
                    </div>
                </div>
                <div class="col-md-2 mt-2">
                    <input type="number" name="jumlahBobot" class="form-control input-default" value="{{ $data->nilai_bobot }}" placeholder="Jumlah Bobot (%)">
                </div>
                <div class="col-md-1 mt-2">
                    <button type="button" class="btn btn-danger btn-sm" id="DeleteRow"><i class="fa-sharp fa-solid fa-trash"></i></button>
                </div>
            </div>
            @endforeach --}}
            {{-- End Form clone --}}
            ...
            <div class="row mt-2">
                <div class="col-md-3 mt-4">
                    <div class="row">
                        <div class="col-md">
                            {{-- Btn Add Row --}}
                            <button type="button" class="btn btn-primary rounded-circle" id="rowAdder"><i class="fa-sharp fa-solid fa-plus"></i></button>
                            {{-- End btn add  Row --}}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mt-3">
                    <div class="row ">
                        ...
                        <div class="col-md">
                            <h6>Poin 1</h6>
                            <input type="number" name="poin1" class="form-control form-control-sm poin1" placeholder="Poin 1" value="{{ $iktisarStaffBulananPerilaku->total_poin1 }}" readonly>
                        </div>
                        ...
                        <div class="col-md">
                            <h6>Poin 2</h6>
                            <input type="number" name="poin2" class="form-control form-control-sm poin2" placeholder="Poin 2" value="{{ $iktisarStaffBulananPerilaku->total_poin2 }}" readonly>
                        </div>
                        ...
                        <div class="col-md">
                            <h6>Poin 3</h6>
                            <input type="number" name="poin3" class="form-control form-control-sm poin3" placeholder="Poin 3" value="{{ $iktisarStaffBulananPerilaku->total_poin3 }}" readonly>
                        </div>
                        ...
                        <div class="col-md">
                            <h6>Poin 4</h6>
                            <input type="number" name="poin4" class="form-control form-control-sm poin4" placeholder="Poin 4" value="{{ $iktisarStaffBulananPerilaku->total_poin4 }}" readonly>
                        </div>
                        ...
                        <div class="col-md">
                            <h6>Poin 5</h6>
                            <input type="number" name="poin5" class="form-control form-control-sm poin5" placeholder="Poin 5" value="{{ $iktisarStaffBulananPerilaku->total_poin5 }}" readonly>
                        </div>
                ...
                <div class="col-md-2 mt-3">
                    <div class="row">
                        <div class="col-md">
                            <h6>Total Bobot (%)</h6>
                            <input type="number" name="totalBobot" class="form-control form-control-sm jumlah-bobot" value="{{ $iktisarStaffBulananPerilaku->total_bobot }}" placeholder="Total Poin" readonly required>
                        </div>
                    </div>
                </div>
                <div class="col-md-1">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md">
                            ...
                            <input type="text" name="totalSum" class="form-control input-default total-sum" value="{{ number_format($iktisarStaffBulananPerilaku->total_poin_kali_bobot, 2) }}" placeholder="input-default" readonly>
                        </div>
                        <div class="col-md">
                            <Label>total Nilai (*80%)</Label>
                            <input type="text" name="totalPresentase" class="form-control input-default total-presentase" value="{{ number_format($iktisarStaffBulananPerilaku->total_nilai_presentase, 2) }}" placeholder="input-default" readonly>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-2">
                    ...
                    <button type="submit" onclick="event.preventDefault(); confirmSubmit();" class="btn btn-primary btn-sm save">
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                var newRow =
                    ...
                    '<div class="row mt-3">' +
                    '<div class="col-md">' +
                    '<input type="radio" {{ $data->question == '
                1 ' ? '
                checked ' : '
