<x-app-layout title="Raport || YPSDMIT">
    @push('style')
    @endpush
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col-md">
                <a href="{{ route('data.raport.ypsdmit', ['id' => $data->user_id, 'tanggalInput' => $tanggalInput->format('Y-m-d'), 'type' => 'pdf']) }}" class="btn btn-primary btn-xs mb-2 float-end">
