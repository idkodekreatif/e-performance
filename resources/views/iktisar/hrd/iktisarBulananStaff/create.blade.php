<x-app-layout title="IKTISAR Bulanan || Staff">
    ...
    <div class="col-xl col-lg">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('iktisar.bulanan.hrd.data.raport') }}" class="btn btn-primary btn-sm mb-2">Search
                    Raport</a>
                <a href="{{ route('iktisar.bulanan.hrd.DataEdit') }}"
                    class="btn btn-primary btn-sm mb-2 mr-2 float-end">Search Edit</a>
            </div>
        </div>
        <form action="{{ route('iktisar.bulanan.hrd.store') }}" id="my-form" method="POST"
