<x-app-layout title="Edit Point A Guru Besar">
    @push('style')
        <style>
    ...
    <div class="col-xl col-lg">
        @role('it' | 'superuser')
            <div class="row page-titles shadow">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Forms Guru Besar </a></li>
        ...
        @role('dosen|hrd')
            <div class="row page-titles shadow">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Point A Guru Besar</a></li>
                </ol>
            </div>
        @endrole
            ...
            <div class="card-body">
                <div class="basic-form">
                    <div class="table-responsive">
                        <form id="my-form" action="{{ route('update.Point-A', [$data->new_user_id]) }}" method="POST"
