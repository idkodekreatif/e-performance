<x-app-layout title="Search Data Poin B">
    @push('style')
    ...
    <div class="col-xl col-lg">
        <div class="row page-titles shadow">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Data Search Poin B</a></li>
            </ol>
        </div>
        <form action="{{ route('Point-B.data.search.result') }}" method="GET">
