        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <div class="table-responsive">
                        <form id="my-form" action="{{ route('update.hrd.Point-D', [$data->new_user_id]) }}"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD1)
                                                <a href="{{ asset('storage/' . $data->fileD1) }}"
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD1"
                                                value="{{ $data->scorD1 }}" name="scorD1" type="number"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D1 == '4' ? 'checked' : '' }}
                                                class="D1" name="D1" id="D1" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D1 == '5' ? 'checked' : '' }}
                                                class="D1" name="D1" id="D1" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD2)
                                                <a href="{{ asset('storage/' . $data->fileD2) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD2"
                                                value="{{ $data->scorD2 }}" name="scorD2" type="number"
                                        ...
                                        <td rowspan="2"><input id="scorSubItemD2"
                                                value="{{ $data->scorSubItemD2 }}" name="scorSubItemD2"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D2 == '1' ? 'checked' : '' }}
                                                class="D2" name="D2" id="D2" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D2 == '2' ? 'checked' : '' }}
                                                class="D2" name="D2" id="D2" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D2 == '3' ? 'checked' : '' }}
                                                class="D2" name="D2" id="D2" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D2 == '4' ? 'checked' : '' }}
                                                class="D2" name="D2" id="D2" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D2 == '5' ? 'checked' : '' }}
                                                class="D2" name="D2" id="D2" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD2 }}"
                                                name="SkorTambahanJumlahSkorD2" id="SkorTambahanJumlahSkorD2"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD2 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD3)
                                                <a href="{{ asset('storage/' . $data->fileD3) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD3"
                                                value="{{ $data->scorD3 }}" name="scorD3" type="number"
                                        ...
                                        <td rowspan="2"><input id="scorSubItemD3"
                                                value="{{ $data->scorSubItemD3 }}" name="scorSubItemD3"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D3 == '1' ? 'checked' : '' }}
                                                class="D3" name="D3" id="D3" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D3 == '2' ? 'checked' : '' }}
                                                class="D3" name="D3" id="D3" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D3 == '3' ? 'checked' : '' }}
                                                class="D3" name="D3" id="D3" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D3 == '4' ? 'checked' : '' }}
                                                class="D3" name="D3" id="D3" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D3 == '5' ? 'checked' : '' }}
                                                class="D3" name="D3" id="D3" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD3 }}"
                                                name="SkorTambahanJumlahSkorD3" id="SkorTambahanJumlahSkorD3"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD3 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD4)
                                                <a href="{{ asset('storage/' . $data->fileD4) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD4"
                                                value="{{ $data->scorD4 }}" name="scorD4" type="number"
                                        ...
                                        <td rowspan="2"><input id="scorSubItemD4"
                                                value="{{ $data->scorSubItemD4 }}" name="scorSubItemD4"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D4 == '1' ? 'checked' : '' }}
                                                class="D4" name="D4" id="D4" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D4 == '2' ? 'checked' : '' }}
                                                class="D4" name="D4" id="D4" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D4 == '3' ? 'checked' : '' }}
                                                class="D4" name="D4" id="D4" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D4 == '4' ? 'checked' : '' }}
                                                class="D4" name="D4" id="D4" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D4 == '5' ? 'checked' : '' }}
                                                class="D4" name="D4" id="D4" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD4 }}"
                                                name="SkorTambahanJumlahSkorD4" id="SkorTambahanJumlahSkorD4"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD4 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD5)
                                                <a href="{{ asset('storage/' . $data->fileD5) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD5"
                                                value="{{ $data->scorD5 }}" name="scorD5" type="number"
                                                aria-label="D5" readonly></td>
                                        <td rowspan="2"><input id="scorMaxD5" name="scorMaxD5"
                                                value="{{ $data->scorMaxD5 }}" type="number" aria-label="D5"
                                                readonly>
                                        </td>
                                        <td rowspan="2"><input id="scorSubItemD5"
                                                value="{{ $data->scorSubItemD5 }}" name="scorSubItemD5"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D5 == '1' ? 'checked' : '' }}
                                                class="D5" name="D5" id="D5" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D5 == '2' ? 'checked' : '' }}
                                                class="D5" name="D5" id="D5" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D5 == '3' ? 'checked' : '' }}
                                                class="D5" name="D5" id="D5" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D5 == '4' ? 'checked' : '' }}
                                                class="D5" name="D5" id="D5" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D5 == '5' ? 'checked' : '' }}
                                                class="D5" name="D5" id="D5" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD5 }}"
                                                name="SkorTambahanJumlahSkorD5" id="SkorTambahanJumlahSkorD5"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD5 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD6)
                                                <a href="{{ asset('storage/' . $data->fileD6) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD6"
                                                value="{{ $data->scorD6 }}" name="scorD6" type="number"
                                        ...
                                        <td rowspan="2"><input id="scorSubItemD6"
                                                value="{{ $data->scorSubItemD6 }}" name="scorSubItemD6"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D6 == '1' ? 'checked' : '' }}
                                                class="D6" name="D6" id="D6" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D6 == '2' ? 'checked' : '' }}
                                                class="D6" name="D6" id="D6" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D6 == '3' ? 'checked' : '' }}
                                                class="D6" name="D6" id="D6" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D6 == '4' ? 'checked' : '' }}
                                                class="D6" name="D6" id="D6" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D6 == '5' ? 'checked' : '' }}
                                                class="D6" name="D6" id="D6" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD6 }}"
                                                name="SkorTambahanJumlahSkorD6" id="SkorTambahanJumlahSkorD6"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD6 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD7)
                                                <a href="{{ asset('storage/' . $data->fileD7) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD7"
                                                value="{{ $data->scorD7 }}" name="scorD7" type="number"
                                        ...
                                        <td rowspan="2"><input id="scorSubItemD7"
                                                value="{{ $data->scorSubItemD7 }}" name="scorSubItemD7"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D7 == '1' ? 'checked' : '' }}
                                                class="D7" name="D7" id="D7" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D7 == '2' ? 'checked' : '' }}
                                                class="D7" name="D7" id="D7" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D7 == '3' ? 'checked' : '' }}
                                                class="D7" name="D7" id="D7" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D7 == '4' ? 'checked' : '' }}
                                                class="D7" name="D7" id="D7" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D7 == '5' ? 'checked' : '' }}
                                                class="D7" name="D7" id="D7" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD7 }}"
                                                name="SkorTambahanJumlahSkorD7" id="SkorTambahanJumlahSkorD7"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD7 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD8)
                                                <a href="{{ asset('storage/' . $data->fileD8) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD8"
                                                value="{{ $data->scorD8 }}" name="scorD8" type="number"
                                        ...
                                        <td rowspan="2"><input id="scorSubItemD8"
                                                value="{{ $data->scorSubItemD8 }}" name="scorSubItemD8"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D8 == '1' ? 'checked' : '' }}
                                                class="D8" name="D8" id="D8" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D8 == '2' ? 'checked' : '' }}
                                                class="D8" name="D8" id="D8" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D8 == '3' ? 'checked' : '' }}
                                                class="D8" name="D8" id="D8" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D8 == '4' ? 'checked' : '' }}
                                                class="D8" name="D8" id="D8" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D8 == '5' ? 'checked' : '' }}
                                                class="D8" name="D8" id="D8" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD8 }}"
                                                name="SkorTambahanJumlahSkorD8" id="SkorTambahanJumlahSkorD8"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD8 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD9)
                                                <a href="{{ asset('storage/' . $data->fileD9) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2" class="bg-warning"><input id="scorD9"
                                                value="{{ $data->scorD9 }}" name="scorD9" type="number"
                                        ...
                                        <td rowspan="2"><input id="scorSubItemD9"
                                                value="{{ $data->scorSubItemD9 }}" name="scorSubItemD9"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D9 == '1' ? 'checked' : '' }}
                                                class="D9" name="D9" id="D9" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D9 == '2' ? 'checked' : '' }}
                                                class="D9" name="D9" id="D9" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D9 == '3' ? 'checked' : '' }}
                                                class="D9" name="D9" id="D9" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D9 == '4' ? 'checked' : '' }}
                                                class="D9" name="D9" id="D9" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D9 == '5' ? 'checked' : '' }}
                                                class="D9" name="D9" id="D9" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahSkorD9 }}"
                                                name="SkorTambahanJumlahSkorD9" id="SkorTambahanJumlahSkorD9"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD9 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD10)
                                                <a href="{{ asset('storage/' . $data->fileD10) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2"><input id="scorMaxD10"
                                                value="{{ $data->scorMaxD10 }}" name="scorMaxD10" type="number"
                                                aria-label="D10" readonly>
                                        </td>
                                        <td rowspan="2"><input id="scorSubItemD10"
                                                value="{{ $data->scorSubItemD10 }}" name="scorSubItemD10"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D10 == '1' ? 'checked' : '' }}
                                                class="D10" name="D10" id="D10" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D10 == '2' ? 'checked' : '' }}
                                                class="D10" name="D10" id="D10" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D10 == '3' ? 'checked' : '' }}
                                                class="D10" name="D10" id="D10" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D10 == '4' ? 'checked' : '' }}
                                                class="D10" name="D10" id="D10" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D10 == '5' ? 'checked' : '' }}
                                                class="D10" name="D10" id="D10" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahD10 }}"
                                                name="SkorTambahanJumlahD10" id="SkorTambahanJumlahD10" readonly>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD10 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            ...
                                            @if ($data->fileD11)
                                                <a href="{{ asset('storage/' . $data->fileD11) }}"
                                                    target="_blank">Preview</a>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td rowspan="2"><input id="scorMaxD11"
                                                value="{{ $data->scorMaxD11 }}" name="scorMaxD11" type="number"
                                                aria-label="D11" readonly>
                                        </td>
                                        <td rowspan="2"><input id="scorSubItemD11"
                                                value="{{ $data->scorSubItemD11 }}" name="scorSubItemD11"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" {{ $data->D11 == '1' ? 'checked' : '' }}
                                                class="D11" name="D11" id="D11" value="1"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D11 == '2' ? 'checked' : '' }}
                                                class="D11" name="D11" id="D11" value="2"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D11 == '3' ? 'checked' : '' }}
                                                class="D11" name="D11" id="D11" value="3"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D11 == '4' ? 'checked' : '' }}
                                                class="D11" name="D11" id="D11" value="4"
                                                onclick="sum();">
                                        </td>
                                        <td><input type="radio" {{ $data->D11 == '5' ? 'checked' : '' }}
                                                class="D11" name="D11" id="D11" value="5"
                                                onclick="sum();">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->SkorTambahanJumlahD11 }}"
                                                name="SkorTambahanJumlahD11" id="SkorTambahanJumlahD11" readonly>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td><input type="number"
                                                value="{{ $data->SkorTambahanJumlahBobotSubItemD11 }}"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" value="{{ $data->TotalSkorUnsurPenunjang }}"
                                                name="TotalSkorUnsurPenunjang" id="TotalSkorUnsurPenunjang"
                                                readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td rowspan="4"><input type="number"
                                                value="{{ $data->NilaiUnsurPenunjang }}"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number"
                                                value="{{ $data->ResultSumNilaiTotalUnsurPenunjang }}"
