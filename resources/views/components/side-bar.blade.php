                ...
                <ul aria-expanded="false">
                    ...
                    @if ($jabstrukNames)
                        <li>
                            ...
                            5. DEKAN & STAFF DEKAN
                            ================================= --}}
                                @if (in_array('Dekan Fakultas Kesehatan', $jabstrukNames) || in_array('Dekan Fakultas Bisnis', $jabstrukNames))
                            ...
                            ================================= --}}
                                @php
                                    $prodiAllowed = [
                                        ...
                                        'Ketua Program Studi S1 Keperawatan dan Ners',
                                        'Ketua Program Studi D3 Kebidanan',
                                    ];

                                    // cek apakah user punya salah satu jabstruk prodi
                                    $hasProdi = array_intersect($jabstrukNames, $prodiAllowed);
                                @endphp

                                @if (!empty($hasProdi))
                                    <li>
                                        <a class="has-arrow" href="javascript:void()">PROGRAM STUDI</a>
                                        <ul>
                                            <li>
                                                <a href="{{ route('iktisar.bulanan.sekkaprodi.create') }}">
                                                    Form Penilaian Sekretaris Prodi
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('sekkaprodi.data.rekap') }}">
                                                    Rekap
                                                </a>
                                            </li>
                                        </ul>
        ...
        <div class="side-bar-profile">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="side-bar-profile-img">
                    ...
                    @else
                        <img src="{{ asset('Assets/images/undraw_profile.svg') }}" width="56"
                            alt="Default Avatar">
                    @endif
                </div>
